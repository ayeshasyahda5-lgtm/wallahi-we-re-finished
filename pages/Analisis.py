...
st.markdown(
    """
   Menarik hasil dari ketiga visualisasi yang kami tampilkan, terdapat pola segmentasi pasar yang jelas.
Pertama, struktur pasar saham Indonesia sangat heterogen (tidak seragam). Dominasi papan "Pengembangan" mengartikan bahwa bursa kita sedang didorong oleh perusahaan-perusahaan skala menengah yang memiliki potensi besar untuk bertumbuh, bukan hanya didominasi oleh raksasa korporasi (Papan Utama).
